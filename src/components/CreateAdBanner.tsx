    ...
    return(
        ...
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
          <div>
            ...
            <span className="text-zinc-400 block">Entre no Discord! QUALQUER COISA VAI NA CASA DO <a href="" className="text-transparent bg-clip-text bg-violet-500">ROCK</a></span>
          </div>  
